...
public class ServiceStudents {
     ...
     */
    public Student updateStudent(String id, String new_firstName, String new_lastName,int new_group, String new_email, String new_guidingTeacher){
    ...
    public void writeToFile() throws IOException {
        repo.writeToFile("src/app/files/studenti.csv");
    }
